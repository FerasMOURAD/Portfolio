        ...
        conteneur.innerHTML = `
            <div class="row">
                ...
                <div class="col-md-4 border-start">
                    ...
                    <p>Kanz AI Hackathon (2026) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[Voir]</a><br>Power BI (UDEMY) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[Voir]</a><br>PIX Niveau Avancé (2025) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[Voir]</a><br>Teens Who Code (2018)</p>
        ...
        conteneur.innerHTML = `
            <div class="row">
                ...
                <div class="col-md-4 border-start">
                    ...
                    <h4 class="text-warning">Certifications</h4>
                    <p>Kanz AI Hackathon (2026) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[View]</a><br>Power BI (UDEMY) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[View]</a><br>PIX Advanced Level (2025) <a href="#" class="text-info small text-decoration-none ms-1" onclick="naviguerVers('certifications')">[View]</a><br>Teens Who Code (2018)</p>
